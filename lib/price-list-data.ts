...
export const PRICE_LIST: PriceItem[] = [
  ...
  // מחברים ישרים
  { id: "i015a", category: "irr_fittings", name: "מחבר ישר 8 מ\"מ",                 unit: "יח'", price: 0 },
  { id: "i015",  category: "irr_fittings", name: "מחבר ישר 16 מ\"מ",                unit: "יח'", price: 1.2 },
  { id: "i015b", category: "irr_fittings", name: "מחבר ישר 20 מ\"מ",                unit: "יח'", price: 0 },
  { id: "i015c", category: "irr_fittings", name: "מחבר ישר 25 מ\"מ",                unit: "יח'", price: 0 },
  { id: "i015d", category: "irr_fittings", name: "מחבר ישר 32 מ\"מ",                unit: "יח'", price: 0 },
  // מחברי T
  { id: "i014a", category: "irr_fittings", name: "מחבר T 8 מ\"מ",                   unit: "יח'", price: 0 },
  { id: "i014",  category: "irr_fittings", name: "מחבר T 16 מ\"מ",                  unit: "יח'", price: 1.5 },
  { id: "i014b", category: "irr_fittings", name: "מחבר T 20 מ\"מ",                  unit: "יח'", price: 0 },
  { id: "i014c", category: "irr_fittings", name: "מחבר T 25 מ\"מ",                  unit: "יח'", price: 0 },
  // זווית
  { id: "i016a", category: "irr_fittings", name: "זווית 8 מ\"מ",                    unit: "יח'", price: 0 },
  { id: "i016",  category: "irr_fittings", name: "זווית 16 מ\"מ",                   unit: "יח'", price: 1.4 },
  { id: "i016b", category: "irr_fittings", name: "זווית 20 מ\"מ",                   unit: "יח'", price: 0 },
  // מעברים (רדוקציות)
  { id: "i035",  category: "irr_fittings", name: "מעבר 20→16 מ\"מ",                 unit: "יח'", price: 0 },
  { id: "i036",  category: "irr_fittings", name: "מעבר 25→20 מ\"מ",                 unit: "יח'", price: 0 },
  { id: "i037",  category: "irr_fittings", name: "מעבר 32→25 מ\"מ",                 unit: "יח'", price: 0 },
  // פקקי קצה
  { id: "i017a", category: "irr_fittings", name: "פקק קצה 8 מ\"מ",                  unit: "יח'", price: 0 },
  { id: "i017",  category: "irr_fittings", name: "פקק קצה 16 מ\"מ",                 unit: "יח'", price: 0.8 },
  { id: "i017b", category: "irr_fittings", name: "פקק קצה 20 מ\"מ",                 unit: "יח'", price: 0 },
  // מחברים לברז
  { id: "i038",  category: "irr_fittings", name: "מחבר לברז ½\" ← 16 מ\"מ",         unit: "יח'", price: 0 },
  { id: "i039",  category: "irr_fittings", name: "מחבר לברז ¾\" ← 20 מ\"מ",         unit: "יח'", price: 0 },
  { id: "i040",  category: "irr_fittings", name: "מחבר לברז ¾\" ← 25 מ\"מ",         unit: "יח'", price: 0 },
  { id: "i041",  category: "irr_fittings", name: "מחבר לברז 1\" ← 32 מ\"מ",         unit: "יח'", price: 0 },
  // מצמדים
  { id: "i042",  category: "irr_fittings", name: "מצמד 16 מ\"מ",                    unit: "יח'", price: 0 },
  { id: "i043",  category: "irr_fittings", name: "מצמד 20 מ\"מ",                    unit: "יח'", price: 0 },
  { id: "i044",  category: "irr_fittings", name: "מצמד 25 מ\"מ",                    unit: "יח'", price: 0 },
  { id: "i045",  category: "irr_fittings", name: "מצמד 32 מ\"מ",                    unit: "יח'", price: 0 },
  // כלים
  { id: "i046",  category: "irr_fittings", name: "מנקב צנרת",                       unit: "יח'", price: 0 },
