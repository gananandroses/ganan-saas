...
export default function QuoteEditPage() {
  ...
  async function handleSave(asDraft = false) {
    ...
    alert(asDraft ? "✅ ההצעה נשמרה כטיוטה" : "✅ ההצעה עודכנה");
      ...
      <div className="px-4 py-5 max-w-4xl mx-auto space-y-4 pb-32">
        ...
        <div className="flex items-center justify-between print:hidden">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">עריכת הצעת מחיר</h1>
              <p className="text-xs text-gray-500">ערוך ושמור את השינויים</p>
            </div>
          </div>
        </div>
